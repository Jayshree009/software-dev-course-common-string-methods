...
// 3. Breaking Apart
let wordsArray = inputString.split(" "); // Split the string into an array of words


// 4. Retrieving
let firstCharacter = trimmedString.charAt(0); // Retrieve the first character of the trimmed string
let extractedBootcamp= inputString.slice(23, 32); // Extract the word "Bootcamp" from the string
